...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-[color:var(--editor-panel-strong)] p-6 shadow-lg transition ease-in-out",
  {
    variants: {
      side: {
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-4 top-4 rounded-full border border-white/20 p-2 text-white/60 transition hover:text-white">
        <X className="h-4 w-4" />
