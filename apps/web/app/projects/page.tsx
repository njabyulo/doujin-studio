...
import { UploadToCreateProjectModal } from "~/features/projects/components/UploadToCreateProjectModal";
    ...
    <div className="min-h-screen bg-[color:var(--ds-background)]">
      ...
      <main className="mx-auto max-w-6xl p-6">
        <div className="mb-8 flex items-center justify-between">
          <h2 className="text-2xl font-bold text-[color:var(--ds-text)]">
            Projects
          </h2>
          <Button
            className="gap-2 rounded-full bg-[color:var(--ds-accent-warm)] text-white hover:bg-[color:var(--ds-accent-warm)]/90"
        ...
        {error ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-card)] py-20 text-center">
            ...
            <h3 className="text-lg font-medium text-[color:var(--ds-text)]">
              No projects yet
            </h3>
            <p className="mt-1 text-[color:var(--ds-muted)]">
              Create your first project to get started.
            </p>
            <Button
              className="mt-6 gap-2 rounded-full bg-[color:var(--ds-accent-warm)] text-white hover:bg-[color:var(--ds-accent-warm)]/90"
              onClick={() => setIsUploadOpen(true)}
            >
              <Plus className="h-4 w-4" />
              Create Project
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {projects.map((project) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="font-semibold text-[color:var(--ds-text)]">
                    {project.title}
                  </h3>
                  <p className="text-sm text-[color:var(--ds-muted)] capitalize">
                    {project.role}
                  </p>
                </div>
              </Link>
