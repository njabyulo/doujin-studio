...
- [x] 2. Shared types and schemas
  - [x] 2.1 Define message type schemas with Zod
  ...
  - [x] 2.2 Define storyboard, script, and brand kit schemas
  ...
  - [x] 2.3 Define format specifications
...
- [x] 3. Better Auth setup in Next.js
...
- [x] 4. Core Route Handlers
  - [x] 4.1 POST /api/projects - Create project
    - Validate auth
    - Create project with userId and title
    - Return project data
    - _Requirements: 12.1_

  - [x] 4.2 GET /api/projects - List projects
    - Validate auth
    - Query projects for userId, sort by updatedAt desc
    - Return project list
    - _Requirements: 12.2, 12.3, 12.4_

  - [x] 4.3 GET /api/projects/:id - Get project with messages and checkpoints
...
- [x] 5. Generation flow with AI SDK streaming
  - [x] 5.1 POST /api/projects/:id/generate - Stream storyboard generation
  ...
  - [x] 5.2 Write property test for streaming delivery
    - **Property 1: Streaming Response Delivery**
    - **Validates: Requirements 2.2**

  - [x] 5.3 Write property test for required extraction fields
    - **Property 2: Required Extraction Fields**
    - **Validates: Requirements 2.6**

  - [x] 5.4 Write property test for best-effort extraction
    - **Property 3: Best-Effort Extraction**
    - **Validates: Requirements 2.7**

- [ ] 6. Checkpoint management
  - [x] 6.1 Implement checkpoint creation helper
  ...
  - [x] 6.2 POST /api/projects/:id/checkpoints/:checkpointId/restore - Restore checkpoint
    - Validate auth and ownership
  ...
  - [x] 6.3 Write property test for checkpoint creation rules
    - **Property 12: Checkpoint Creation Rules**
    - **Validates: Requirements 6.1, 6.2, 6.3, 6.4, 6.5, 22.3**

  - [x] 6.4 Write property test for checkpoint source linkage
    - **Property 13: Checkpoint Source Linkage**
    - **Validates: Requirements 6.6**

- [ ] 7. Scene editing and regeneration
  - [x] 7.1 PATCH /api/projects/:id/scenes/:sceneId - Edit scene
    - Validate auth and ownership
  ...
  - [x] 7.2 POST /api/projects/:id/regenerate-scene - Regenerate scene with AI
  ...
  - [x] 7.3 Write property test for scene regeneration isolation
    - **Property 24: Scene Regeneration Isolation**
    - **Validates: Requirements 14.6**

- [ ] 8. Render job queue and worker
  - [x] 8.1 POST /api/projects/:id/render - Enqueue render job
  ...
  - [x] 8.2 Create SQS queue and worker Lambda
  ...
  - [x] 8.3 Implement render worker logic
  ...
  - [x] 8.4 Write property test for render state transitions
    - **Property 25: Render State Transitions**
    - **Validates: Requirements 15.5, 15.6, 15.7, 16.3**

- [ ] 9. Render progress and cancellation
  - [x] 9.1 GET /api/render-jobs/:id/progress - Poll render progress
    - Validate auth and ownership
  ...
  - [x] 9.2 POST /api/render-jobs/:id/cancel - Soft-cancel render
    - Validate auth and ownership
  ...
  - [x] 9.3 GET /api/render-jobs/:id/download-url - Generate signed URL
    - Validate auth and ownership
...
- [ ] 12. Observability
  ...
  - [x] 12.2 Write property test for correlation ID propagation
    - **Property 29: Correlation ID Propagation**
    - **Validates: Requirements 24.2, 24.4**

- [ ] 13. UI - Empty state
  - [x] 13.1 Create empty state component
  ...
  - [x] 13.2 Write unit test for empty state rendering
    - Test with no projects
    - Test with recent projects
    - _Requirements: 11.1, 11.4_

- [ ] 14. UI - Generating state
  - [x] 14.1 Create generating state component
  ...
  - [x] 14.2 Implement AI SDK stream consumer
...
- [ ] 15. UI - Generated state
  ...
  - [x] 15.2 Implement Remotion Player with responsive scaling
  ...
  - [x] 15.3 Write property test for no horizontal overflow
...
- [ ] 17. UI - Render progress
  ...
  - [x] 17.3 Write unit test for polling backoff
...
- [ ] 21. Schema versioning
  - [x] 21.1 Add version validation to message schemas
    - Check version field exists in all message contentJson
    - Validate against type-specific schema
    - _Requirements: 26.1, 26.3_

  - [x] 21.2 Add version validation to checkpoint schemas
    - Check version field exists in storyboard, script, brandKit
    - Validate against versioned schemas
    - _Requirements: 26.2, 26.3_

  - [x] 21.3 Write property test for schema version presence
    - **Property 31: Schema Version Presence**
    - **Validates: Requirements 26.1, 26.2**

- [ ] 22. Property-based tests
  - [x] 22.1 Write property test for message type correctness
    - **Property 6: Message Type Correctness**
    - **Validates: Requirements 4.2, 4.3, 6.9, 6.10, 8.8**

  - [x] 22.2 Write property test for artifact reference linkage
    - **Property 7: Artifact Reference Linkage**
    - **Validates: Requirements 4.6**

  - [x] 22.3 Write property test for chronological message ordering
    - **Property 8: Chronological Message Ordering**
    - **Validates: Requirements 4.7**

  - [x] 22.4 Write property test for complete message history
    - **Property 9: Complete Message History**
    - **Validates: Requirements 4.8**

  - [x] 22.5 Write property test for message schema versioning
    - **Property 10: Message Schema Versioning**
    - **Validates: Requirements 5.10**

  - [x] 22.6 Write property test for message content validation
    - **Property 11: Message Content Validation**
    - **Validates: Requirements 5.11**

  - [x] 22.7 Write property test for checkpoint restoration
    - **Property 14: Checkpoint Restoration**
    - **Validates: Requirements 6.8**

  - [x] 22.8 Write property test for render from any checkpoint
    - **Property 15: Render from Any Checkpoint**
    - **Validates: Requirements 6.11**

  - [x] 22.9 Write property test for generated artifact completeness
    - **Property 17: Generated Artifact Completeness**
    - **Validates: Requirements 8.5, 8.6, 8.7**

  - [x] 22.10 Write property test for format-agnostic content
    - **Property 18: Format-Agnostic Content**
    - **Validates: Requirements 9.5**

  - [x] 22.11 Write property test for format-specific layout
    - **Property 19: Format-Specific Layout Application**
    - **Validates: Requirements 9.6, 9.7**

  - [x] 22.12 Write property test for multi-format rendering
    - **Property 20: Multi-Format Rendering**
    - **Validates: Requirements 9.8**

  - [x] 22.13 Write property test for scene structure completeness
    - **Property 21: Scene Structure Completeness**
    - **Validates: Requirements 10.2, 10.3, 10.4, 10.5**

  - [x] 22.14 Write property test for total duration calculation
    - **Property 22: Total Duration Calculation**
    - **Validates: Requirements 10.6**

  - [x] 22.15 Write property test for storyboard schema validation
    - **Property 23: Storyboard Schema Validation**
    - **Validates: Requirements 10.7**

  - [x] 22.16 Write property test for active checkpoint synchronization
    - **Property 27: Active Checkpoint Synchronization**
    - **Validates: Requirements 22.3, 22.4**

  - [x] 22.17 Write property test for signed URL security
